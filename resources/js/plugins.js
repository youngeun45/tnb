...
$.extend(Microfiche.prototype, {
  ...
  // We create our film element, which we占쎌뀴l slide back and forth in the screen.
  // Before appending any extra elements, we detach the existing children,
  // append them to film, and tell them to float so they占쎌뀴l (hopefully) lay-out
  ...
  // This slightly strange process tries to ensure we don占쎌뀽 get any wrapping
  ...
  //
  // If we占쎌뀻e not already in drag-mode, we check to see if the horizontal
  ...
  // to be a drag, we占쎌뀴l deduce the new target value for x, ensure Microfiche
  ...
  // Handle what happens in cyclic mode if we占쎌끀e slipped off at either end.
  ...
  // Slide to the previous screen占쎌뀼-worth of slides.
  prev: function() {
    this.slideByPages(-1);
  },

  // Slide to the next screen占쎌뀼-worth of slides.
  next: function() {
    this.slideByPages(1);
  },
